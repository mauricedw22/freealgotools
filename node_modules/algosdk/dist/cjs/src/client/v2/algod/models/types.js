...
class DryrunTxnResult extends base_1.default {
     ...
     * @param logs -
     */
    constructor({ disassembly, appCallMessages, appCallTrace, globalDelta, localDeltas, logicSigMessages, logicSigTrace, logs, }) {
        super();
 ...
 * Application Log
 */
class LogItem extends base_1.default {
    /**
...
class PendingTransactionResponse extends base_1.default {
     ...
     */
    constructor({ poolError, txn, applicationIndex, assetClosingAmount, assetIndex, closeRewards, closingAmount, confirmedRound, globalStateDelta, localStateDelta, logs, receiverRewards, senderRewards, }) {
        super();
